pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/Mauricette-eng/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('fouodom-225')   // <---- Change this to match your kubernetes cluster credentials
    }
